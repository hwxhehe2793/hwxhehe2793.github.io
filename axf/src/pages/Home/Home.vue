    ...
    <div class="main">
      ...
      <ul class="acts-category">
        <li class="acts-category-item" v-for="(item,index) in classifys" @click="gethotsale(item)">
          ...
          <router-link :to="{path: 'hotsale' , query: {id:item.id}}">
          ...
          <ul class="acts-category-item-goodsList">
            <li v-for="(pro,ind) in item.products">
             <router-link :to="{path: 'details' , query: { id: item.id,product_id : pro.product_id,whose:'homeproducts'}}" >
             	 <img class="acts-category-item-goodsList-img" :src="pro.imgs.small">
             </router-link>
